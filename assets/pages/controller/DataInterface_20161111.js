...
var initApiList = function() {
  ...
  //var strUrl = getRootPath(1) + '/DataInterface/Api?Token=' + config.TOKEN + '&ID=0&M=3' + '&author=' + username + '&cache=1440';
  var strUrl = getRootPath(1) + '/DataInterface/Api?ID=0' + '&author=' + username + '&cache=1440'; //+'&t=' + Math.random();
