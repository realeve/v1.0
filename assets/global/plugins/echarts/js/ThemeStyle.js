...
var labelFromatter = {
    normal : {
		color: '#ccc',
        label : {
            formatter : function (a,b,c){return xround(100-c,2) + '%'},//用四舍五入解决浮点的问题
            textStyle: {
                baseline : 'top',
				fontsize:'30',
            }
...
var MPtStyle = {
	data : [
		...
		{type : 'max', name: '最大值'}//'heart'（心形）、'droplet'（水滴）、'pin'（标注）、'arrow'（箭头）和'star'
	]
}
var MPtStyleMax = {
	data : [
		...
		{type : 'min', name: '最小值'}//'heart'（心形）、'droplet'（水滴）、'pin'（标注）、'arrow'（箭头）和'star'
	]
}
var MPtStyleMin = {
	data : [
