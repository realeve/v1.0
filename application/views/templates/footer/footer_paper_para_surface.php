...
<script type="text/javascript" src="../../assets/global/plugins/jquery.form.js" ></script>
...
<script type="text/javascript" src="../../assets/pages/controller/PaperPara_surface.min.js"></script>
<!--END MY LEVEL SCRIPT-->
<!-- END JAVASCRIPTS -->
</body>
<!-- END BODY -->
