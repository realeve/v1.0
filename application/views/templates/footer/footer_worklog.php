...
<script type="text/javascript" src="<?php echo base_url()?>assets/admin/pages/controller/WorkLogEdit.min.js"></script>
...
<script>
  //记录选择状态
   ...
   jQuery(document).ready(function() {    
       ...
       WorkLogInit();//初始化表单
          //属性设置
       var GroupID = <?php echo $GroupID-1; ?>;//机检组
       //工序
       $(SwitchSelect('workProc',GroupID)).bootstrapSwitch('toggleState');
       //班次
