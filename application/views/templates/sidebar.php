	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu font-yahei" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="交互式质量数据可视化图表">
					<a href="javascript:;">
					...
					<ul class="sub-menu">
						<li>
							...
							<ul class="sub-menu">
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="#"><i class="icon-power"></i> 横切光标间距</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i> 对角线差</a>
										</li>
										<li>
											<a href="#"><i class="icon-star"></i> 单幅水印宽 </a>
										</li>
										<li>
											<a href="#"><i class="icon-star"></i> 单幅水印高 </a>
										</li>
										<li>
											<a href="#"><i class="icon-star"></i> 抄宽 </a>
										</li>
									</ul>
								</li>
								<li>
									<a href="#"><i class="icon-camera"></i> 缺陷类型统计 </a>
								</li>
								<li>
									<a href="#"><i class="icon-link"></i> 缺陷区域统计 </a>
								</li>
								<li>
									<a href="#"><i class="icon-pointer"></i> 小开缺陷统计 </a>
								</li>
								<li>
									<a href="#"><i class="icon-pointer"></i> 缺陷类型分布 </a>
								</li>
							</ul>
						</li>
						<li>
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="#"><i class="icon-star"></i> 月度质量汇总</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i> 当天质量汇总</a>
										</li>
										<li>
											<a href="#"><i class="icon-graph"></i> 原始质量数据</a>
										</li>
									</ul>
								</li>
								<li>
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="#"><i class="icon-tag"></i> 各品种质量汇总</a>
								</li>
								<li>
									<a href="#"><i class="icon-pencil"></i>各机台质量汇总</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 各机长平均好品率</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 原始质量数据</a>
								</li>
						...
						<li>
							...
							<ul class="sub-menu">								
								<li>
									<a href="#"><i class="icon-pencil"></i>胶凹机台实废情况</a>
								</li>
								<li>
									<a href="#"><i class="icon-tag"></i>印码机台实废情况</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i>小开分析仪</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i>FLC荧光标定仪</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="#"><i class="icon-tag"></i> 清分机质量曲线 </a>
								</li>
								<li>
									<a href="#"><i class="icon-pencil"></i> 装箱情况 </a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="#"><i class="icon-tag"></i> 备用1</a>
								</li>
								<li>
									<a href="#"><i class="icon-pencil"></i> 备用2</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 备用3</a>
								</li>
							</ul>
						</li>
					</ul>
				...
				<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="交互式质量数据报表">
					<a href="javascript:;">
					...
					<ul class="sub-menu">
						<li>
							...
							<ul class="sub-menu">
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="#"><i class="icon-power"></i> 宏区算法参数</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i> 纸区算法参数</a>
										</li>
										<li>
											<a href="#"><i class="icon-star"></i> 安全线算法参数 </a>
										</li>
									</ul>
								</li>
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="#"><i class="icon-power"></i> 宏区判废标准</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i> 纸区判废标准</a>
										</li>
										<li>
											<a href="#"><i class="icon-star"></i> 安全线判废标准 </a>
										</li>
									</ul>
								</li>
								<li>
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="<?php echo base_url()?>QualityTable"><i class="icon-tag"></i> 各品种质量汇总</a>
								</li>
								<li>
									<a href="#"><i class="icon-pencil"></i>各机台质量汇总</a>
								</li>
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							...
							<ul class="sub-menu">
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="#"><i class="icon-power"></i> 年度分析</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i> 半年分析</a>
										</li>
										<li>
											<a href="#"><i class="icon-star"></i> 月度分析</a>
										</li>
									</ul>
								</li>
								<li>
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="http://localhost/Addition/QualityAnaly/index.html" target="_Blank"><i class="icon-tag"></i> 2014印钞质量分析</a>
								</li>
								<li>
									<a href="#"><i class="icon-pencil"></i> 2014印码三合一作废分析 </a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 印码机检未检数分布情况 </a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 不同时间开印产品质量对比</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 白班/中班开印产品质量对比</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 胶凹各机长质量对比</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 胶凹机长异常品分布</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 2011-2015印码机检好品率对比</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 印码机台误废分析</a>
								</li>
								<li>
									<a href="#"><i class="icon-graph"></i> 胶凹机台实废分析</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub-menu">
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="#"><i class="icon-power"></i> 连续开位缺陷数较多产品</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i> 连续开位缺陷数较少产品</a>
										</li>
									</ul>
								</li>
								<li>
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="#"><i class="icon-power"></i>个人事务</a>
								</li>
								<li>
									<a href="#"><i class="icon-paper-plane"></i>部门事务</a>
								</li>
								<li>
									<a href="#"><i class="icon-star"></i>机检组事务</a>
								</li>
							</ul>
						</li>
						<li>
						...
						<li>
							<a href="<?php echo base_url()?>MicroBlog">
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="javascript:;"><i class="icon-power"></i>机检系统状态<span class="arrow"></span></a>
									<ul class="sub-menu">
										<li>
											<a href="#"><i class="icon-power"></i>硬盘使用情况</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i>数据上传情况</a>
										</li>
										<li>
											<a href="#"><i class="icon-power"></i>检测系统异常监测</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i>数据库用量</a>
										</li>
										<li>
											<a href="#"><i class="icon-power"></i>模型备份情况</a>
										</li>
										<li>
											<a href="#"><i class="icon-paper-plane"></i>模型验证情况</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="javascript:;"><i class="icon-paper-plane"></i>实时质量信息
										<span class="arrow"></span></a>
										<ul class="sub-menu">											
											<li>
												<a href="#"><i class="icon-paper-plane"></i>小张核查</a>
											</li>
											<li>
												<a href="#"><i class="icon-power"></i>码后核查</a>
											</li>
											<li>
												<a href="#"><i class="icon-paper-plane"></i>丝印品</a>
											</li>
										</ul>
								</li>
							</ul>
				...
				<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="1.提交车号（自动关联机长、工艺、机型等生产信息）;</br>2.异常描述;</br>3.机台">
					<a href="javascript:;">
					<i class="icon-bar-chart"></i>
				...
				<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="1.类似于南钞的形式">
					<a href="javascript:;">
					<i class="icon-bar-chart"></i>
					...
					<ul class="sub-menu">
						...
						<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="1.小张核查、码后核查</br>2.清分机全检</br>3.清分机加抽</br>4.人工全检/复检</br>5.图像重新判废</br>6.图像判废审核">
							<a href="charts_flotcharts.html">
							流程更改</a>
						</li>
					</ul>
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="1.由图像判废班班长提交结果；</br>2.系统对当天判废结果按条数与区域排序；</br>3.大于指定条目时反馈至胶凹班长；</br>4.连续实废较多的产品反馈至胶凹班长">
							<a href="javascript:;">
				...
				<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="1.以车号/轴号来检索;</br>2.一站式入口">
					<a href="javascript:;">
					<i class="icon-bar-chart"></i>
				...
				<li>
					...
					<ul class="sub-menu">
						<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="宏区编号、宏区参数、宏区范围">
				...
				<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="点击查看各机检系统软件版本">
					...
					<ul class="sub-menu">
						...
						<li>
							...
							<ul class="sub-menu">								
								...
								<li>
									<a href="components_dropdowns.html">多功能</a>							
								</li>
								<li>
									<a href="components_dropdowns.html">丝凸机</a>							
								</li>	
								<li>
									<a href="components_dropdowns.html">双色机</a>							
								</li>		
							</ul>
						</li>
						<li>
