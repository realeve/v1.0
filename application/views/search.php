                ...
                <div class="mt-element-list bg-white">
	                ...
	                <div class="mt-list-container list-simple ext-1 group">
	                	...
	                	<a class="list-toggle-container" data-toggle="collapse" href="#productInfo" aria-expanded="false">
	                        <div class="list-toggle bg-default bg-font-default uppercase"> 生产信息
	                            <span class="badge badge-default pull-right bg-white bg-font-default bold" name="prodNum">0</span>
	                        </div>
	                    </a>
	                    <div class="panel-collapse collapse in" id="productInfo">
	                        <div class="cbp-popup-container bg-white mt-element-ribbon" style="padding:0 20px 30px 20px;">
	                    ...
	                    <a class="list-toggle-container" data-toggle="collapse" href="#offlineInfo" aria-expanded="false">
	                        <div class="list-toggle done uppercase"> 离线检测
