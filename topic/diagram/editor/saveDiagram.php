        ...
        <div id="page">
            ...
            <div id="content" style="text-align: center;">
                ...
                <div class="form" style="width: 400px;">
                    <div class="formTitle" >
                        <span class="menuText" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">保存</span>
                    </div>
                    ...
                    <form style="position: relative; height: 280px;" action="./common/controller.php" method="post">
                        ...
                        <div style="position: absolute; top: 160px; left: 20px;">
                            <input type="checkbox" name="public" value="true" /><span class="formLabel">共享</span>                            
                        </div>
                        ...
                        <div style="position: absolute; top: 240px; left: 20px; right: 20px;">
                            <input onclick="return validateForm();" type="image" src="./assets/images/save.gif" style="display: block; margin-left: auto; margin-right: 0;" value="保存"/>
                        </div>
