        ...
        <div id="page">
            ...
            <div id="content"  style="text-align: center;">
                ...
                <div class="form" style="width: 400px;">
                    <div class="formTitle" >
                        <span class="menuText" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">设置</span>
                    </div>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="vertical-align: middle; text-align: right;">
                                       ...
                                       <input type="image" src="./assets/images/save.gif" style="vertical-align: middle;"  value="保存"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
