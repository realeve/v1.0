	...
	function slidify(markdown, options) {
		...
		for (var i = 0, len = sectionStack.length; i < len; i++) {
			...
			if (sectionStack[i] instanceof Array) {
				...
				markdownSections += '<slide class="slide"><section class="slide-wrapper" ' + options.attributes + ' data-markdown>' + createMarkdownSlide(sectionStack[i], options) + '</section></slide>';
			}
		}
