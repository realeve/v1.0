...
require(['jquery.fullPage', 'jquery-weui'], function() {
	...
	function getExamTemplate(data, i) {
		...
		str += '<h1 class="answer-num title-hor blue-font" style="margin-top:100px;">第<span>' + i + '</span>题</h1>';
		str += '<div class="weui_cells_title blue-font" style="margin-top:-5px;line-height:1.2;">' + data.title + '</div>' +
		...
		str += '<div class="info-tips" name="fixed" style="top:80%;"><span style="color:#ed1515;">' + exam.tips[i - 1].year + '</span><img class="years" src="./assets/img/years.png">' +
			'<p style="color:#ed1515;margin-top:-5px;">' + exam.tips[i - 1].tip + '</p></div><img name="fixed" src="./assets/img/mainTheme.jpg" class="background_dark" style="height:100%;top:0;position:absolute;display:block;margin:0 auto;z-index:-1;"></div>';
		return str;
	}
