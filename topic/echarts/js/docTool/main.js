...
! function(e, t) {
	...
	h.fn.ready = function(e) {
		...
		if (T.addEventListener) T.addEventListener("DOMContentLoaded", H, !1), e.addEventListener("load", H, !1);
		else {
	...
	var t = e("jquery"),
		n = "__isDTLibSet",
		r = function(e) {
			this._valueSet = {}, this[n] = !0, this.reset(e)
		};
	return r.getSet = function(e) {
		...
		constructor: r,
		add: function(e) {
			return t.extend(this._valueSet, this._normalize(e)), this
		},
		union: function(e) {
			return this.add(e)
		},
		...
		contains: function(e) {
			...
			for (var n in t)
				if (t.hasOwnProperty(n) && !this._valueSet.hasOwnProperty(n)) return !1;
			return !0
		},
		intersects: function(e) {
			var t = this._normalize(e),
				n = [];
			for (var i in t) t.hasOwnProperty(i) && this._valueSet.hasOwnProperty(i) && n.push(i);
			return new r(n)
		},
		subtracts: function(e) {
			var t = this._normalize(e),
				n = [];
			for (var i in this._valueSet) this._valueSet.hasOwnProperty(i) && !t.hasOwnProperty(i) && n.push(i);
			return new r(n)
		},
		isEmpty: function() {
			return this.count() === 0
		...
		filter: function(e) {
			var t = this._valueSet,
				n = [];
			for (var i in t) t.hasOwnProperty(i) && e(i) && n.push(i);
			return new r(n)
		},
		map: function(e) {
			var t = this._valueSet,
				n = [];
			for (var i in t) t.hasOwnProperty(i) && n.push(e(i));
			return new r(n)
		},
		classify: function(e, t) {
			...
			for (var c = 0, h = (t || []).length; c < h; c++) s[t[c]] || (s[t[c]] = new r);
			return s
		},
		_normalize: function(e) {
			var n = {}, i = t.type(e);
			if (!e) return n;
			if (r.isSet(e)) e = e.list();
			else if (i === "string") {
				e = e.split(",");
				for (var s = 0, o = e.length; s < o; s++) e[s] = t.trim(e[s])
			} else if (i !== "array") throw new Error;
			for (var s = 0, o = e.length; s < o; s++) n[e[s]] = 1;
			return n
		}
	}, r
	...
	function d(e) {
		var n = {}, r = t.type(e);
		if (r === "array")
			for (var i = 0, s = e.length; i < s; i++) n[e[i]] = e[i];
		else if (r === "object")
	...
	f.arraySlice = c(n), f.curry = function(e) {
		var t = n.call(arguments, 1);
		return function() {
			return e.apply(this, t.concat(n.call(arguments)))
		}
	}, f.ieVersion = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? document.documentMode || +RegExp.$1 : undefined, f.encodeHTML = function(e) {
		...
		if (h)
			for (var r = 0; n = p[r++];) e[n] !== Object.prototype[n] && t(n, e[n])
	};
	var h = !{
		toString: 1
	...
	f.localUID = function() {
		...
		return t.attach = function(t) {
			var n = "__private_s_",
				r = "__private_attach_",
				i = t.prototype;
			return i.hasOwnProperty(r) ? e = i[r] : i[r] ? e = i[r] = n + (Number(i[r].split("_s_")[1]) + 1) : e = i[r] = n + "0", t
		}, t
	}, f.isComponent = function(e, t) {
		return Object(e) !== e ? !1 : (t && (e[u] = 1), !! e[u])
	}, f.getComponent = function(e) {
		return f.isJQuery(e) && (e = e[0]), e ? e[a] : !1
	}, f.bindComponent = function(e, t) {
		return f.isJQuery(e) && (e = e[0]), e ? (f.isComponent(t) ? e[a] = t : t === !1 && (e[a] = null), e[a]) : !1
		...
		for (var u in t)
			if (t.hasOwnProperty(u) && !o.hasOwnProperty(u)) {
				...
				if (a != null) {
					if (i && e.hasOwnProperty(a)) throw new Error('Target attr "' + a + '" exists!');
					e[a] = t[u]
				}
			}
		return e
	...
	return f.isEmptyObj = function(e) {
		...
		if (!e) return -1;
		if (arguments.length < 3 && typeof r == "function") return r.call(e, t);
		for (var i = 0, s = e.length; i < s; i++)
			if (arguments.length < 3 && e[i] === t || v(e[i]) && e[i][n] === t) return i;
		return -1
		...
		var n = [];
		for (var r = 0, i = (e || []).length; r < i; r++) n.push(t(e[r]));
		return n
	}, f.arrayEquals = function(e, n) {
		if (!t.isArray(e) || !t.isArray(n) || e.length !== n.length) return !1;
		for (var r = 0, i = e.length; r < i; r++)
			if (e[r] !== n[r]) return !1;
		return !0
	}, f.objectKeys = function(e) {
		var t = [];
		if (!f.isObject(e)) return t;
		for (var n in e) e.hasOwnProperty(n) && t.push(n);
		return t
		...
		if (s !== o) return p();
		if (s === "array") {
			if (e.length !== n.length) return p();
			for (var u = 0, a = e.length; u < a; u++) i.push(u), f.diffObjects(e[u], n[u], r, i), i.pop()
		} else if (s === "object" && o === "object") {
			var l = f.objectKeys(e),
				c = f.objectKeys(n);
			if (!f.arrayEquals(l, c)) return p();
			for (var u = 0, a = l.length; u < a; u++) {
				var h = l[u];
				i.push(h), f.diffObjects(e[h], n[h], r, i), i.pop()
			}
		} else if (s === "date") {
			if (e.getTime() !== n.getTime()) return p()
		} else if (s === "regexp") {
			if (e.toString() !== n.toString()) return p()
		} else if (e !== n) return p();
		return r
		...
		return e.onload = e.onerror = function() {
			if (this.width !== 1 || this.height !== 1) t = !1
		...
		return e = null, t
	}(), f.noop = new Function, f.onlyHasProperty = function(e, n) {
		var r = !0;
		if (n == null) return !1;
		t.isArray(n) || (n = [n]);
		for (var i in e) e.hasOwnProperty(i) && f.arrayIndexOf(n, i) === -1 && (r = !1);
		return r
	}, f
	...
	return t.throttle = function(e, t, n, r) {
		function d(h) {
			function p() {
				o = (new Date).getTime(), u = null, (c ? e : e[h]).apply(f, l || [])
			}
			return function() {
				i = (new Date).getTime(), f = this, l = arguments, a = i - (r ? s : o) - t, clearTimeout(u), r ? n ? u = setTimeout(p, t) : a >= 0 && p() : a >= 0 ? p() : n && (u = setTimeout(p, -a)), s = i
			}
		}
		var i = (new Date).getTime(),
			...
			o = 0,
			u = null,
			a, f, l, c = typeof e == "function";
		t = t || 0;
		if (c) return d();
		var h = [];
		for (var p = 0; p < e.length; p++) h[p] = d(p);
		return h
	...
	function y(e, t) {
		var n = [],
			r, i, s = this[u + "children"];
		for (r = 0; i = s[r]; r++) n.push(i.getCallback());
		n = t(n, e);
		for (r = 0; i = s[r]; r++) i.setCallback(n[r])
	}
	...
	function w(e, t, n, r) {
		...
		var i = this();
		if (r && r.force || this.isDifferent(i[e], t))(!r || !r.silent) && this.valueWillMutate(), i[e] = t, (!r || !r.silent) && this.valueHasMutated();
		N(this, r)
	}
	...
	function N(e, t) {
		var n = t && t.volatiles || [],
			r = e[u + "currValueInfo"];
		for (var i = 0, s = n.length; i < s; i++) delete r[n[i]]
	}
	var t = e("./base"),
		n = e("jquery"),
		r = e("./throttle"),
	...
	var c = {
		...
		notify: function(e, t) {
			t = t || a;
			if (!this.hasSubscriptionsForEvent(t)) return;
			var n = this._subscriptions[t].slice();
			for (var r = 0, i; i = n[r]; r++) i.callback(e)
		},
		...
		equalityComparer: p
			...
			this[u + "callback"] = e, this[u + "callbackScope"] = t, this[u + "disposeCallback"] = n, this[u + "isDisposed"] = !1
		}, v = d.prototype;
	v.callback = function(e) {
		return this[u + "isDisposed"] || this[u + "callback"].apply(this[u + "callbackScope"], e || []), this
	}, v.setCallback = function(e) {
		return this[u + "callback"] = e, this
	}, v.getCallback = function() {
		return this[u + "callback"]
	}, v.dispose = function() {
		return this[u + "isDisposed"] = !0, this[u + "disposeCallback"](), this
	}, v.throttle = function(e) {
		return this[u + "callback"] = r.fixedRate(this[u + "callback"], e), this
	}, v.debounce = function(e) {
		return this[u + "callback"] = r.debounce(this[u + "callback"], e), this
	};
	var m = function(e) {
		this[u + "children"] = n.extend([], e)
	}, g = m.prototype;
	g.callback = function(e) {
		for (var t = 0, n; n = this[u + "children"][t]; t++) n.callback(e)
	}, g.dispose = function() {
		for (var e = 0, t; t = this[u + "children"][e]; e++) t.dispose()
	}, g.throttle = function(e) {
		return y.call(this, e, r.fixedRate), this
	}, g.debounce = function(e) {
		return y.call(this, e, r.debounce), this
		...
		return x(e) && (e = e.peek(), r = e.peekValueInfo()), a[u + "currValue"] = e, a[u + "currValueInfo"] = r, a[u + "authKey"] = i ? i.authKey : null, s.subscribable(a), t.assign(a, b), a[o] = "ob", a[u + "writer"] = function(e, r, i) {
			a.validateAuthKey(i ? i.authKey : null), t.assert(r == null || n.isPlainObject(r)), a[u + "currValueInfo"] = r;
			var s = i && i.force;
			if (s || a.isDifferent(a[u + "currValue"], e))(!i || !i.silent) && a.valueWillMutate(), a[u + "currValue"] = e, (!i || !i.silent) && a.valueHasMutated();
			N(this, i)
		}, a
	};
	var b = {
		force: function(e, t, n) {
			n = n || {}, n.force = !0, this[u + "writer"](e, t, n)
		},
		peek: function() {
		...
		peekValueInfo: function(e) {
			if (arguments.length === 0) {
				...
				return r && (r = n.extend({}, r)), r
			}
			if (t.isObject(this[u + "currValueInfo"])) return this[u + "currValueInfo"][e]
		},
		extendWriter: function(e) {
			var t = this,
				n = t[u + "writer"];
			return this[u + "writer"] = function(r, i, s) {
				t.validateAuthKey(s ? s.authKey : null), e.call(t, n, r, i, s)
			}, this
		},
		...
		validateAuthKey: function(e) {
			...
			if (t != null && e !== t) throw new Error("AuthKey error: " + e)
		}
	};
	s.obHash = function(e) {
		var t = s.ob(e || {});
		return t[o] = "obHash", t.prop = w, t
	}, s.obArray = function(e) {
		t.assert(e === l || n.isArray(e));
		var r = s.ob(e || []);
		return t.assign(r, E), r[o] = "obArray", r
	};
	var E = {
		remove: function(e) {
			var t = this(),
				n = [],
				r, i = [];
			for (var s = 0, o = t.length; s < o;)(typeof e == "function" ? e(t[s]) : t[s] === e) ? (r || (this.valueWillMutate(), r = !0), n.push(t.splice(s, 1)), i.push(s), o--) : s++;
			if (n.length) {
				var u = {
					key: S.REMOVE,
					indexes: i
				};
				this.notify([u, this], f), this.valueHasMutated()
			}
			return n
		},
		removeAll: function() {
		...
		splice: function(e, t) {
			var n = this(),
				...
				s = arguments.length;
			if ( !! s && e >= 0 && e <= r) {
				s === 1 ? t = r : t >= 0 ? t > r - e && (t = r - e) : t = 0, this.valueWillMutate();
				...
				return this.notify([u, this], f), this.valueHasMutated(), o
			}
			return []
		},
		slice: function() {
		...
		move: function(e, t) {
			...
			this.notify([s, this], f), this.valueHasMutated()
		}
	...
	s.obSubscribe = function(e, t, r, i) {
		if (x(e)) return e.subscribe(t, r, i);
		if (n.isArray(e)) {
			var s = [];
			for (var o = 0, u = e.length; o < u; o++) x(e[o]) && s.push(e[o].subscribe(t, r, i));
			return new m(s)
		}
	}, s.value = function(e) {
		return x(e) ? e() : e
		...
		return t = s.peek(t), T(e) ? (e(t, n), e) : t
	}, s.valueInfo = function(e, n) {
		return t.isObject(e) ? t.assign({}, e, ["type", "info"]) : {
			type: e,
			info: n
		}
	}, s.valueInfo.CONFIRMED = "confirmed", s.valueInfoForConfirmed = function(e, n) {
		var r = s.valueInfo(s.valueInfo.CONFIRMED, e);
		return n && t.assign(r, n, null, ["type", "info"]), r
	...
	var t = e("jquery"),
		...
		r = e("./dataDriven"),
		i = {}, s = "__atom__",
		o, u = i.isAtom = function(e, i) {
			return Object(e) !== e || !i && e[s] || r.obTypeOf(e) || n.isComponent(e) || !t.isPlainObject(e)
		};
	i.isPlain = function(e, n) {
		return t.isArray(e) || !u(e, n)
	}, i.atom = function(e) {
		return Object(e) === e && !e[s] && (e[s] = 1), e
	}, i.cloneAtom = function(e, i) {
		var o = t.type(e),
			f, l;
		if (!u(e, !0)) {
			if (e[s]) return e[s] = 0, l = a({}, e, {
				clone: !0
			}), l[s] = e[s] = 1, l;
			return
		}
		if (f = r.obTypeOf(e)) return r[f](a({}, e.peek(), {
			clone: !0
		}));
		if (n.isComponent(e)) return e.clone();
		if (o === "date") return new Date(e.getTime());
		if (o === "regexp") return new RegExp(e);
		if (o === "array") {
			l = [];
			for (var c in e) e.hasOwnProperty(c) && (l[c] = a({}, e[c], {
				clone: !0
			}));
			return l
		}
		if (o in {
			...
			number: 1,
			string: 1
		} || i && i.assignWhenCannotClone) return e
	};
	var a = i.merge = function(e, t, n) {
		if (t === o) return e;
		if (u(t)) return n && n.clone ? i.cloneAtom(t, n) : t;
		u(e) && (e = {});
		var r = n && n.levelOneNeedMerge;
		n && (n.levelOneNeedMerge = null);
		for (var s in t) {
			if (!t.hasOwnProperty(s) || n && n.onlyMergeOwnPropertyInTarget && !e.hasOwnProperty(s)) continue;
			e[s] = !r || r[s] ? a(e[s], t[s], n) : t[s]
		}
		return e
	};
	...
	var c = t.setByPath = function(e, t, n, r, s) {
		...
		for (var f = 0, l, c = o.length; f < c; f++) {
			a = o[f];
			var p = a.length;
			l = 0, a.indexOf("]") === p - 1 && (o[f] = a = a.slice(0, p - 1), l = 1);
		...
		return typeof s == "function" ? t = s(u, a, t) : u[a] = t, t
	}, h = c.Action = {
			DRILL_DOWN: "drillDown",
			THROW: "throw",
			RETURN: "return",
	...
	return t.deleteByPath = function(e, t, n, i) {
		...
		for (var o = n.length; s < o; s++) {
			var u = n[s],
				a = u.length,
				f = !1;
			u.indexOf("]") === a - 1 && (f = !0, u = u.slice(0, a - 1));
			if (u !== t[s]) break;
			r.push((s === 0 ? "" : f ? "[" : ".") + n[s])
		}
		return r.join("")
	...
	function i(e) {
		...
		return o(i.defineProperties, e._define), e._define = null, i.implement(e), u._applySuper = r, u._superClass = n, u.constructor = i, i
	}
	...
	return t.newClass = function(e) {
		...
		return t.extend = i, t.implement = s, o(t.defineProperties = {}, e._define), e._define = null, t.implement(e), t.uid = "Class_" + n.localUID(), t
	}, t.simpleInherit = function(e, t) {
		var n = e.prototype,
			i = new Function;
		i.prototype = t.prototype;
		var s = e.prototype = new i;
		return o(s, n), s._applySuper = r, s._superClass = t, s.constructor = e, e
	}, t
	...
	var t = e("jquery"),
		...
		s = {
			addEventListener: function(e, t) {
				n(e) && (t = e, e = "*"), this.__listeners = this.__listeners || {};
				var i = this.__listeners[e] || (this.__listeners[e] = []);
				return r(i, t) < 0 && i.push(t), this
			},
			removeEventListener: function(e, t) {
				...
				if (i)
					if (t) {
						var s = r(i, t);~
						s && delete i[s]
					} else i.length = 0, delete this.__listeners[e];
				return this
			},
	...
	function s(e) {
		...
		if (t.type(e) === "array") {
			n = {};
			for (var r = 0, i = e.length; r < i; r++) n[e[r]] = e[r]
		} else n = e;
		return n
	}
	...
	function o(e) {
		for (var t in e)
			if (e.hasOwnProperty(t) && !r.test(t)) throw new Error('Key must be spelled like "AAAA_BBB".')
	}
	var t = e("jquery"),
		n = {}, r = /^[A-Z][A-Z_]*$/;
	n.makeEnum = function(e, n) {
		function r() {}
		return n = n || {}, e = s(e), o(e), t.extend(r.prototype, i, n), t.extend(new r, e)
	};
	var i = {
		has: function(e) {
		...
		contains: function(e, n) {
			...
			for (var r = 0, i = n.length; r < i; r++) {
				var s = !1;
				for (var o = 0, u = e.length; o < u; o++) this[e[o]] === n[r] && (s = !0);
				if (!s) return !1
			}
			return !0
		},
		forEachEnum: function(e, t) {
			for (var n in this) this.hasOwnProperty(n) && r.test(n) && e.call(t, n, this[n])
		}
	};
	return n
	...
	return n.globalDisable = function(e) {
		...
		var s;
		if (e === !1) s = o(t), s && s.hide().off("." + i);
		else {
			e == null && (e = .5), s = o(t, n, !0), s.css({
				opacity: e
			}).show();
			for (var u in r) r.hasOwnProperty(u) && s.on(u + "." + i, r[u])
		}
	...
	t.ordinalSuffix = function(e) {
		...
		var n = "",
			r = e < 0,
			i = String(Math.abs(e));
		return i.length < t && (n = (new Array(t - i.length + 1)).join("0")), (r ? "-" : "") + n + i
		...
		return a = n.replace(/I+,*I*/g, function() {
			...
			if (t >= 0 && t !== c.length - 1) {
				i = e.length - 1 - t;
				var o;
				while ((o = c.length - i) > 0 && i > 0) s.push(c.substr(o, i)), c = c.substring(0, o);
				s.push(c), s.reverse(), s[0] === "-" ? (s.shift(), n = "-" + s.join(",")) : n = s.join(",")
			} else n = c;
			return r && n && n.indexOf("-") < 0 && (n = "+" + n), n
	...
	function r(e, n) {
		switch (e.nodeType) {
			case 1:
				...
				for (var a = 0, f = s.length; a < f; a++)~ o.indexOf(s[a].name) && u.setAttribute(s[a].name, s[a].value);
				var l = e.childNodes;
	...
	function f(e, n, r, i) {
		var s = i.singleLineDepth,
			o = s != null ? s <= r ? "single" : "multiple" : "auto",
			u = i.quotationMark,
			p = i.indentBase,
			d = i.lineBreak,
			v = i.inlineDelimiterSpace,
			m = t.type(e),
			g = (new Array(r * p + 1)).join(" "),
			y = (new Array((r + 1) * p + 1)).join(" "),
			b = !1,
			w = n != null ? l(n, u) + ": " : "",
			E;
		switch (m) {
			case "function":
				b = o !== "single", E = w + a.printFunction(e, r, p);
				break;
			case "regexp":
				E = w + u + e + u;
				break;
			...
			case "array":
				...
				for (var x = 0, T = e.length; x < T; x++) {
					...
					S.push(N.str), N.hasLineBreak && (b = !0)
				}
				o === "multiple" && (b = !0);
				var C = b ? d : "",
					k = "," + (b ? d + y : v),
	...
	return a.jsReservedWords = ["break", "delete", "function", "return", "typeof", "case", "do", "if", "switch", "var", "catch", "else", "in", "this", "void", "continue", "false", "instanceof", "throw", "while", "debugger", "finally", "new", "true", "with", "default", "for", "null", "try", "abstract", "double", "goto", "native", "static", "boolean", "enum", "implements", "package", "super", "byte", "export", "import", "private", "synchronized", "char", "extends", "int", "protected", "throws", "class", "final", "interface", "public", "transient", "const", "float", "long", "short", "volatile"], a.jsReservedWordsMap = function(e) {
		var t = {};
		for (var n = 0, r = e.length; n < r; n++) t[e[n]] = 1;
		return t
	}(a.jsReservedWords), a.stringifyJSObject = function(e, t) {
		t = t || {}, t.indentBase == null && (t.indentBase = n), t.lineBreak == null && (t.lineBreak = r), t.quotationMark == null && (t.quotationMark = i);
		if (t.quotationMark !== '"' && t.quotationMark !== "'") throw new Error("Illegal quotation mark: " + t.quotationMark);
		t.compress && (t.indentBase = 0, t.lineBreak = ""), t.inlineDelimiterSpace = t.compress ? "" : " ";
		try {
			var s = f(e, null, 0, t);
			return s.str
		} catch (o) {
		...
		var i = (new Array((n + 1) * r)).join(" "),
			s = (e + "").split("\n"),
			o = "";
		return s.length > 1 && t.trim(s[s.length - 1]) === "}" && (s.pop(), o = "\n" + (new Array(n * r)).join(" ") + "}"), s.join("\n" + i) + o
	}, a
	...
	r.parseURL = function(e) {
		...
		!n && (n = "src-origin"), e.each(function(e, r) {
			r = t(r);
			var i = r.data(n);
			i && (r.attr("src", i), r.data(n, ""))
		})
		...
		var e, n, i = "BAIDUHUI_BALLOON_TIP_SHOWN",
			s = "DNOT_SHOW_WHEN_CLOSE";
		return function(o, u, a, f) {
			function l() {
				e && e.hide(), n === s && r.cookie(i, 1), n = null
			}
			if (o === !1) l();
			else {
				n = f;
				if (n === s && r.cookie(i)) return;
				e || (e = t(['<div class="balloon-tip">', '<div class="content"></div>', '<div class="triangle"><i></i><em></em></div>', '<div class="close-btn">X</div>', "</div>"].join("")).hide().appendTo(document.body), t(".close-btn", e).click(l)), t(".content", e).html(o), e.css({
					position: "absolute",
					left: u,
					top: a
				}).show()
		...
		if (t != null) return document.cookie = e + "=" + encodeURIComponent(t), t;
		var n = new RegExp("(^| )" + e + "=([^;]*)(;|$)"),
	...
	function() {
		...
		var t = document,
			n = t.body,
			r = t.createElement("a");
		r.style.display = "none", r.href = e || "#", r.target = "_blank", n.appendChild(r), r.click(), n.removeChild(r)
	};
	...
	return r.replaceIntoParam = function(e, t, r) {
		...
		var i = new RegExp("([&~?])" + t + "=[^&]*"),
			o = t + "=" + r;
		return i.test(e) ? e = e.replace(i, "$1" + o) : e = s(e, o), e
	}, r.strTemplate = function(e, r) {
		e = String(e);
		var s = Array.prototype.slice.call(arguments, 1);
		return s.length ? (s = s.length === 1 ? n.isObject(r) ? r : s : s, e.replace(i, function(e, n) {
			var r = s[n];
			return t.isFunction(r) && (r = r(n)), r == null ? "" : r
		})) : e
	...
	function() {
		...
		r.enableBeforeUnloadCheck = function() {
			if (t) return;
			t = !0, window.onbeforeunload = function() {
				var t;
	...
	function d() {
		return c || (c = t('<div class="' + u + '" ' + 'style="display:none;"></div>').appendTo(document.body)), c
	}
	var t = e("jquery"),
		n = e("../lib/base"),
		r = e("../lib/model"),
	...
	return l.showTooltip = function(e) {
		...
		t = e.encodeHTML !== !1 ? n.encodeHTML(t) : t, d().html(t).show(), p(e.location)
		...
		function E(e) {
			...
			if (c) n.x += e.pageX, n.y += e.pageY;
				...
				var r = t(e.currentTarget),
					o = r.offset();
				n.x += o.left + r.outerWidth() / 2, n.y += o.top
			}
			return n
		}
		e = r.merge({}, e, {
		...
		var h = t(e.bindEl),
			...
			y = e.selector;
		y && (v.splice(1, 0, y), m.splice(1, 0, y), g.splice(1, 0, y)), h.on.apply(h, v).on.apply(h, m), c && h.on.apply(h, g);
		var S = {
			refresh: function() {
				d && l.showTooltip({
					text: w(d),
			...
			dispose: function() {
				d && (l.hideTooltip(), d = null), h.off(o)
			}
		};
		return S
	}, l
		...
		for (var t = 1, n = arguments.length; t < n; t++) {
			...
			for (var i in r)
				if (r.hasOwnProperty(i)) {
					if (e[i]) throw new Error("Duplicate key: " + i);
					e[i] = r[i]
				}
		}
		return e
	...
	return n(t, e("./lib/base"), e("./lib/json"), e("./lib/dataDriven"), e("./lib/objectAccess"), e("./lib/objectOriented"), e("./lib/model"), e("./lib/event"), e("./lib/enumeration"), e("./lib/disable"), e("./lib/number"), e("./lib/throttle"), e("./lib/htmlCleaner"), e("./lib/codeStringify"), e("./lib/others"), e("./ui/tooltip")), t
}), ! function(e) {
	function t(e, t) {
		for (var n in t) t.hasOwnProperty(n) && (e[n] = t[n]);
		return e
	...
	function f(e) {
		return e = e.replace(/^\s*\*/, ""), a('gv({0},["{1}"])', o(e), e.replace(/\[['"]?([^'"]+)['"]?\]/g, function(e, t) {
			return "." + t
		}).split(".").join('","'))
	}
		...
		for (var o = n.length, u = e.split(t), a = 0, f = [], l = 0, c = u.length; c > l; l++) {
			...
			if (l) {
				...
				for (a++;;) {
					...
					if (a = r ? a - 1 : 0, f.push(a > 0 && p ? t : "", h.slice(0, d), a > 0 ? n : ""), h = h.slice(d + o), p = 0, 0 === a) break
				}
				0 === a && (i(f.join("")), s(h), f = [])
			} else h && s(h)
		}
		a > 0 && f.length > 0 && (s(t), s(f.join("")))
	}
	...
	function c(e, t, n) {
		var r, i = [],
			...
			h = "",
			p = "";
		return n && (u = "ts(", a = ")", h = D, p = P, r = s.defaultFilter), l(e, s.variableOpen, s.variableClose, 1, function(e) {
			n && e.indexOf("|") < 0 && r && (e += "|" + r);
			var s = e.indexOf("|"),
			...
			if (l) {
				...
				for (var m = l.split("|"), g = 0, y = m.length; y > g; g++) {
					var b = m[g];
					/^\s*([a-z0-9_-]+)(\((.*)\))?\s*$/i.test(b) && (v.unshift('fs["' + RegExp.$1 + '"]('), RegExp.$3 && v.push(",", RegExp.$3), v.push(")"))
				}
			}
			i.push(h, v.join(""), p)
		}, function(e) {
	...
	function v(e, t) {
		...
		this.master = RegExp.$3, this.name = RegExp.$1, p.call(this, e, t), this.blocks = {}
	}

	function m(e, t) {
		if (!/^\s*([a-z0-9\/_-]+)\s*$/i.test(e)) throw new Error("Invalid " + this.type + " syntax: " + e);
		this.name = RegExp.$1, p.call(this, e, t), this.cloneProps = ["name"]
	}

	function g(e, t) {
		if (!/^\s*([a-z0-9\/_-]+)\s*$/i.test(e)) throw new Error("Invalid " + this.type + " syntax: " + e);
		this.name = RegExp.$1, p.call(this, e, t), this.cloneProps = ["name", "state", "blocks"], this.blocks = {}
	}

	function y(e, t) {
		if (!/^\s*([a-z0-9_]+)\s*=([\s\S]*)$/i.test(e)) throw new Error("Invalid " + this.type + " syntax: " + e);
		this.name = RegExp.$1, this.expr = RegExp.$2, p.call(this, e, t), this.cloneProps = ["name", "expr"]
	}

	function b(e, t) {
		if (!/^\s*([a-z0-9_-]+)\s*(\(([\s\S]*)\))?\s*$/i.test(e)) throw new Error("Invalid " + this.type + " syntax: " + e);
		this.name = RegExp.$1, this.args = RegExp.$3, p.call(this, e, t), this.cloneProps = ["name", "args"]
	}
	...
	function E(e, t) {
		...
		this.list = RegExp.$1, this.item = RegExp.$2, this.index = RegExp.$4, p.call(this, e, t), this.cloneProps = ["list", "item", "index"]
	}
	...
	function N(e, t) {
		...
		if (n.targets[r]) switch (n.options.namingConflict) {
			case "override":
				n.targets[r] = e, t.targets.push(r);
			case "ignore":
				break;
			default:
				throw new Error("Target exists: " + r)
		} else n.targets[r] = e, t.targets.push(r)
	}

	function C(e, t) {
		F[e] = t, t.prototype.type = e
	}
	...
	function L(e, t) {
		function r() {
			...
			if (c.length > 0 && (e = c.join(""))) {
				var n = new h(e, t);
				n.beforeAdd(f), a.top().addChild(n), c = [], t.options.strip && f.current instanceof p && (n.value = e.replace(/^[\x20\t\r]*\n/, "")), f.current = n
			}
		}
		var i, s = t.options.commandOpen,
			o = t.options.commandClose,
			u = t.options.commandSyntax,
			a = new n,
			f = {
				engine: t,
				targets: [],
		...
		return l(e, s, o, 0, function(e) {
			...
			if (n && (i = F[n[2].toLowerCase()]) && "function" == typeof i) {
				r();
				var a = f.current;
				t.options.strip && a instanceof h && (a.value = a.value.replace(/\r?\n[\x20\t]*$/, "\n")), n[1] ? a = d(f, i) : (a = new i(n[3], t), "function" == typeof a.beforeOpen && a.beforeOpen(f), a.open(f)), f.current = a
			} else /^\s*\/\//.test(e) || c.push(s, e, o);
			i = null
		}, function(e) {
			c.push(e)
		}), r(), d(f), f.targets
	...
	var A = 178245,
		...
		P = ";",
		H = "return r;";
	"undefined" != typeof navigator && /msie\s*([0-9]+)/i.test(navigator.userAgent) && RegExp.$1 - 0 < 8 && (_ = "var r=[],ri=0;", D = "r[ri++]=", H = 'return r.join("");'), h.prototype = {
	...
	i(v, p), i(m, p), i(g, p), i(y, p), i(b, p), i(w, p), i(E, p), i(S, p), i(x, S), i(T, S);
	var j = {
		READING: 1,
		READED: 2,
		APPLIED: 3,
	...
	g.prototype.applyMaster = v.prototype.applyMaster = function(e) {
		function t(e) {
			...
			if (r instanceof Array)
				for (var i = 0, s = r.length; s > i; i++) {
					var o = r[i];
					o instanceof m && n[o.name] && (o = r[i] = n[o.name]), t(o)
				}
		}
		if (this.state >= j.APPLIED) return 1;
		var n = this.blocks,
			r = this.engine.targets[e];
		return r && r.applyMaster(r.master) ? (this.children = r.clone().children, t(this), this.state = j.APPLIED, 1) : void 0
		...
		function e(r) {
			for (var i = 0, s = r.children.length; s > i; i++) {
				...
				if (o instanceof g) {
					...
					n = n && u && u.isReady(t)
				} else o instanceof p && e(o)
			}
		}
		if (this.state >= j.READY) return 1;
		var t = this.engine,
			n = 1;
		return this.applyMaster(this.master) ? (e(this), n && (this.state = j.READY), n) : void 0
		...
		d(e), p.prototype.open.call(this, e), this.state = j.READING, N(this, e)
	}, y.prototype.open = w.prototype.open = function(e) {
		e.stack.top().addChild(this)
	}, m.prototype.open = function(e) {
		p.prototype.open.call(this, e), (e.imp || e.target).blocks[this.name] = this
		...
		this.parent = e.stack.top(), this.target = e.target, p.prototype.open.call(this, e), this.state = j.READING, e.imp = this
	}, w.prototype.close = y.prototype.close = function() {}, g.prototype.close = function(e) {
		p.prototype.close.call(this, e), this.state = j.READED, e.imp = null
	}, v.prototype.close = function(e) {
		p.prototype.close.call(this, e), this.state = this.master ? j.READED : j.APPLIED, e.target = null
		...
		return this.applyMaster(this.name), p.prototype.getRendererBody.call(this)
	...
	var F = {};
	C("target", v), C("block", m), C("import", g), C("use", w), C("var", y), C("for", E), C("if", S), C("elif", x), C("else", T), C("filter", b), k.prototype.config = function(e) {
		t(this.options, e)
	...
	var I = new k;
	I.Engine = k, "object" == typeof exports && "object" == typeof module ? exports = module.exports = I : "function" == typeof define && define.amd ? define("etpl", I) : e.etpl = I
}(this), define("dt/tpl", ["require", "etpl", "./lib"], function(e) {
	function i(e) {
		var t = !1,
			r = !1;
		for (var i = 1; i < arguments.length; i++) arguments[i] === "raw" && (t = !0), arguments[i] === "null" && (r = !0);
		return e == null && !r && (e = ""), n.obTypeOf(e) && (e = e()), e = String(e), t ? e : n.encodeHTML(e)
	}

	function s(e) {
		return e == null && (e = ""), String(e).replace(/^option\./, "")
	}
	var t = e("etpl"),
		n = e("./lib"),
		r = {};
	return t.config({
		...
		commandClose: "}}",
		defaultFilter: "ob"
	}), t.addFilter("ob", i), t.addFilter("dsp", s), r.render = function(e, n, r) {
		return !t.getRenderer(e) && r && t.compile(r), t.render(e, n || {})
	}, r
	...
	function l() {
		...
		e.visible = n.ob(!0);
		var t = e.disabled;
		e.disabled = n.ob(!1), t != null && this._disposable(t.subscribe(r, this))
	}

	function c(e) {
		if (!e) return;
		var r = o(this);
		e = r.$el = t(e), r.el = e[0], n.bindComponent(e, this), e.addClass(this.getFullCss().join(" "));
		var i = this._viewModel(),
			s = i.disabled,
			u = i.visible;
		this._disposable(s.subscribe(h, this)), this._disposable(u.subscribe(p, this)), h.call(this, s()), u(e[0].style.display !== "none")
	}
	...
	function v() {
		var e = this.$el(),
			t = o(this);
		e.off(t.eventNamespace), e.removeClass(this.getFullCss().join(" ")), t.viewModel = null, t.el = null, t.$el = null, t.subComponents = null, t.sub$Els = null, n.bindComponent(e, !1)
	}

	function m(e, r, i) {
		if (!i && n.isComponent(e) || i && n.isJQuery(e)) r(e);
		else if (t.type(e) === "object" && !n.isAtom(e))
			for (var s in e) e.hasOwnProperty(s) && e[s] != null && m(e[s], r, i)
	}

	function g(e) {
		var t = o(this),
			r = t.viewModel = {}, i = this;
	...
	function y() {
		var e = o(this),
			t = e.viewModelPublicMap = {}, n = e.viewModelMergeMap = {};
		this._traverseFromAncestor(function(e) {
			var r = e.defineProperties.viewModelPublic || [];
			for (var i = 0, s = r.length; i < s; i++) t[r[i]] = 1;
			var o = e.defineProperties.viewModelMerge || [];
			for (var i = 0, s = o.length; i < s; i++) n[o[i]] = 1
		})
	}
	...
	function b() {
		...
		var i = e && e.css || [];
		t.isArray(i) || (i = [i]), n.extraCss = i
	}

	function w(e) {
		return e = i.normalizePath(e), !! o(this).viewModelPublicMap[e]
	}

	function E(e) {
		if (e && t.isFunction(e.dispose)) try {
			e.dispose()
		} catch (r) {
			if (f.debug) throw r;
			f.printLog && f.printLog.error(r)
		} else e && n.isJQuery(e) && e.off(this._event())
	}

	function S(e) {
		e = e || o(this).subComponents, m(e, function(e) {
			try {
				e.dispose()
			} catch (t) {
				if (f.debug) throw t;
	...
	var t = e("jquery"),
		...
		f = o.attach(n.newClass(n.enableEvent({
			...
			_construct: function(e, r, i) {
				arguments.length > 0 && n.assert(e != null), !e || t.isPlainObject(e) ? (i = r, r = e, e = null) : e = t(e), i = t.extend({}, i), n.isComponent(this, !0);
				var s = o(this);
				s.cptDef = i, s.eventNamespace = ".namespace" + n.localUID(), s.subComponents = {}, s.sub$Els = {}, s.disposed = !1, s.cptDisposableArea = {}, s.cptInstanceUID = "cpt-instance-" + n.localUID(), y.call(this), r = this._parseViewModel(r || {}, i) || {}, g.call(this, r), b.call(this), l.call(this), c.call(this, e), this._prepare(), d.call(this), this._init()
			},
			dispose: function() {
				var e = o(this);
				if (!e.disposed) {
					var t = this.el(),
						n = this[a] || "";
					this._dispose(), S.call(this), x.call(this), this._disposable(!1), v.call(this), this._disposeFinally(), t.innerHTML = n, e.disposed = !0
				}
			},
			isDisposed: function() {
			...
			_disposable: function(e, r) {
				...
				if (e == null) return e;
				if (e === !1)
					for (var s in i) i.hasOwnProperty(s) && (E.call(this, i[s]), i[s] = null);
				else t.type(e) === "string" ? (E.call(this, i[e]), i[e] = null) : (n.assert(t.isFunction(e.dispose) || n.isJQuery(e), "No dispose method nor not jQuery!"), r = r || "-component-anonymouse-disposable" + n.localUID(), i[r] = e);
				return e
			},
			resize: t.noop,
			_manuInitView: function(e) {
				c.call(this, e), this._constructSub(e)
			},
			...
			_renderTpl: function(e, n, i) {
				...
				return i && t(i)[this._viewModel().tplRenderMode](o), o
			},
			_constructSub: function(e, r) {
				var i = t(e);
				n.assert(i.length), r && i.data("cpt") && this._constructSubCpt.call(this, e);
				var s = this;
			...
			_constructSubCpt: function(e) {
				var r = t(e),
					...
					c = new f(e, l, u);
				return c[a] = s, this._sub(u.name || "-sub-cpt-name-" + n.localUID(), c)
			},
			...
			_sub: function(e, t, n) {
				...
				return arguments.length < 2 ? i(e, r, i.actionChoice.notPlainReturn) : (s(e, t, r, n ? s.actionChoice.notPlainOverlap : s.actionChoice.notPlainThrow), t)
			},
			...
			$el: function(e, t, n) {
				var r = o(this);
				return arguments.length === 0 ? r.$el : arguments.length === 1 ? i(e, r.sub$Els, i.actionChoice.notPlainReturn) : (s(e, t, r.sub$Els, n ? s.actionChoice.notPlainOverlap : s.actionChoice.notPlainThrow), t)
			},
			css: function() {
				return this._getDefineProperty("css") || ""
			},
			viewModel: function(e) {
				if (w.call(this, e)) return i(e, o(this).viewModel);
			...
			getFullCss: function(e) {
				var n = [u],
					r = o(this);
				return n.push.apply(n, r.basicCss || []), n.push.apply(n, r.extraCss || []), t.map(n, function(t) {
					return t + (e || "")
				})
			},
			isDisabled: function() {
			...
			_traverseFromAncestor: function(e) {
				var t = [];
				for (var n = this.constructor; n; n = n.prototype._superClass) t.push(n);
				for (var r = t.length; r--;) e.call(this, t[r])
			},
			localOb: function(e, t) {
				var r, i = o(this),
					s = i.localObRepo || (i.localObRepo = {});
				return arguments.length > 1 ? t === !1 ? (r = s[e], delete s[e]) : (n.assert(s[e] == null), r = s[e] = t) : r = s[e], r
			},
	...
	return f.cptClasses = {}, f.defaultLanguageSet = {}, f.defaultConstant = {}, f.consoleLog = function(e) {
	...
	return i.getGlobalArg = function(e, t) {
		...
		var n = (new Function("return (" + e + ")"))(),
			i = t.type(n);
		return r.assert(i === "object" || i === "array"), n
		...
		var o = {};
		n === "first" && (o[t] = i);
		for (var s in e) e.hasOwnProperty(s) && s !== t && (n === "before" && s === r && (o[t] = i), o[s] = e[s], n === "after" && s === r && (o[t] = i));
		return n === "last" && (o[t] = i), o
	...
	var t = e("jquery"),
		...
		f = /^([^\[\]\-]+|i\])(\-([a-zA-Z_ \/,]*))?$/,
		l = {};
	l.EC_OPTION_TYPE = ["Array", "Object", "string", "number", "boolean", "color", "Function", "Date"], l.EC_AXIS_APPLICABLE = ["category", "value", "time", "log"], l.EC_SERIES_APPLICABLE = ["line", "bar", "scatter", "k", "pie", "radar", "chord", "force", "map", "gauge", "funnel", "eventRiver", "venn", "treemap", "tree", "wordCloud", "heatmap"], l.EC_ITEM_STYLE_APPLICABLE = l.EC_SERIES_APPLICABLE.concat(["markPoint", "markLine"]), l.parseOptionPath = function(e, r) {
		r = r || {};
		...
		for (var u = 0, a = s.length; u < a; u++) {
			var l = t.trim(s[u]);
			if (r.ignoreEmptyItem && l === "") continue;
			var c = l.match(f) || [],
				h = c[1],
				p = c[2],
				d = c[3],
				v = {}, m = o[o.length - 1];
			h === "i]" ? v.arrayName = (m.arrayName || m.propertyName) + "[i]" : v.propertyName = h, p && (v.typeEnum = d), o.push(v)
		}
		if (r.arrayOnlyAtom)
			for (var u = 0, a = o.length; u < a;) {
				var g = o[u],
					y = o[u + 1];
				y && y.arrayName ? (g.applicable && !y.applicable && (y.applicable = new n.Set(g.applicable)), o.splice(u, 1)) : u++
			}
		return o
		...
		for (var i = 0, s = e.length; i < s; i++) {
			...
			o.typeEnum && (a += "-" + o.typeEnum), t.html && (a = n.encodeHTML(a || ""), i === e.length - 1 && (a = "<strong>" + a + "</strong>")), r.push(a)
		}
		return r.join(".")
		...
		function s(e, t, r) {
			...
			if (!i) {
				...
				if (!e.isEnumParent) return
			}
			for (var f = 0, l = (e.children || []).length; f < l; f++) {
				var c = e.children[f],
					h = null;
				if (e.isEnumParent) {
					if (!o || !o.typeEnum || c.typeEnum === o.typeEnum) h = r
				} else t.optionPath && u(c, i.propertyName, i.arrayName) ? h = r + 1 : t.fuzzyPath && (a(c, i.propertyName, i.arrayName) ? h = r + 1 : h = r);
				h != null && s(c, t, h)
			}
		}
		...
		function o(e, t) {
			...
			for (var r = 0, i = (e.children || []).length; r < i; r++) o(e.children[r], t)
		}
		...
		function a(e, t, n) {
			return t != null && (t = t.toLowerCase()), n != null && (n = n.replace(/\[i\]/g, "").toLowerCase()), e.propertyName != null && e.propertyName.toLowerCase().indexOf(t) >= 0 || e.arrayName != null && e.arrayName.toLowerCase().indexOf(n != null ? n : t) >= 0
		}
		...
		return n.assert((i.optionPath || i.fuzzyPath || i.anyText) && ( !! i.optionPath && !! i.fuzzyPath) == 0, "invalid query string!"), i.optionPath || i.fuzzyPath ? s(e, i, 0) : o(e, i), i.result
		...
		function f(e, t, r) {
			...
			if (r.optionPath) {
				...
				var f = v(a);
				f.hasOwnProperty("propertyName") && (f.arrayName = f.propertyName, delete f.propertyName), f.arrayName += "[i]"
			}
			var l;
			r.schemaPath && (l = r.schemaPath.slice(), l.push("items")), u(i, t.items, o({
				itemName: r.itemName,
				relationInfo: c.IS_ARRAY_ITEM,
				arrayFrom: s ? (s.push(t), s) : [t],
				optionPath: a,
				schemaPath: l
			}))
		}
		...
		function p(e, t, r) {
			...
			for (var f in a)
				if (a.hasOwnProperty(f)) {
					var l;
					r.optionPath && (l = n.clone(r.optionPath), l.push({
						propertyName: f
					}));
					var h;
					r.schemaPath && (h = r.schemaPath.slice(), h.push("properties", f)), u(i, a[f], o({
						itemName: f,
		...
		function d(e, t, n) {
			n.selfInfo = c.IS_ATOM, n.docRenderer(e, t, n)
		}

		function v(e) {
			return e.length > 0 ? e[e.length - 1] : null
		}
		return i = i || l.buildDoc.docJsonRenderer, u(r, e.option, o({
			optionPath: []
		})), r
	};
	...
	return l.buildDoc.docJsonRenderer = function(e, t, s) {
		function w(t, r) {
			...
			return r.relationInfo === c.IS_ARRAY_ITEM ? a.arrayName = r.itemName + (new Array(r.arrayFrom.length + 1)).join("[i]") : a.propertyName = r.itemName, a
		}
		...
		function E(e, t) {
			...
			return r.hasOwnProperty("default") && (i.defau["default"] = r["default"]), i
		}
		var o = s.selfInfo,
			u = s.enumInfo,
		...
		if (s.enumInfo !== c.IS_ENUM_ITEM) {
			var v = s.itemName;
			v && (f = '<span class="ecdoc-api-tree-text-prop">' + i(v) + "</span>", r.getGlobalArg("pureTitle") || (f += ": "));
			var m = s.arrayFrom;
			if (m) {
		...
		var y = [];
		if (o === c.HAS_OBJECT_PROPERTIES) a.childrenPre = f + "{", a.childrenPost = "}" + p + ",", a.childrenBrief = d, y.push(a);
		else if (o === c.IS_ATOM) {
			var b = l.getDefaultValueText(a.defau, {
				getBrief: !0
			});
			a.text = f, r.getGlobalArg("pureTitle") || (a.text += '<span class="ecdoc-api-tree-text-default">' + i(b) + "</span>" + p + ","), y.push(a)
		} else u === c.IS_ENUM_PARENT && (a.childrenPre = f, a.childrenPost = p + ",", a.childrenBrief = d, y.push(a));
		return y.length && (e.children = (e.children || []).concat(y)), a
		...
		var s = e["default"],
			u = t.type(s);
		if ("null,undefined,number,boolean".indexOf(u) >= 0) return s + "";
		if (u === "string") return n.getBrief ? d(s, o) : s;
		if (n.getBrief) return i[u] || i["?"];
		try {
	...
	return t.extend(r, s.cn || {}), t.extend(i, s.en || {}), (t("html").attr("lang") + "").toLowerCase() === "en" ? i : r
}),
function(e) {
...
function() {
	var e = function(e) {
		var t = function(t) {
			...
			function T() {
				l = r.createElement("iframe"), l.src = "about:blank", l.style.display = "none", r.body.appendChild(l)
			}

			function N() {
				if (l && u !== x()) {
					var e = l.contentWindow.document;
					e.open(), e.write("<html><head><title>" + r.title + '</title><script type="text/javascript">var frameHash="' + u + '";</script></head><body>&nbsp;</body></html>'), e.close()
				}
			}
			...
			function C(e, t) {
				if (u !== e) {
					var n = u;
					u = e, g && (t ? l.contentWindow.frameHash = e : N()), o.changed.dispatch(E(e), E(n))
				}
			}
			...
			function A(e) {
				...
				return t = t ? o.prependHash + t.replace(d, "") + o.appendHash : t, t
			}

			function O(e) {
				return e = encodeURI(e), v && y && (e = e.replace(/\?/, "%3F")), e
			}
			var n = 25,
				r = t.document,
				i = t.history,
				...
				d = /^\#/,
				v = !1,
				m = "onhashchange" in t && r.documentMode !== 7,
				g = v && !m,
				y = location.protocol === "file:";
			return g ? c = function() {
				var e = S(),
					t = x();
				...
				init: function() {
					if (f) return;
					u = S(), m ? k(t, "hashchange", c) : (g && (l || T(), N()), a = setInterval(c, n)), f = !0, o.initialized.dispatch(E(u))
				},
				stop: function() {
					if (!f) return;
					m ? L(t, "hashchange", c) : (clearInterval(a), a = null), f = !1, o.stopped.dispatch(E(u))
				},
				isActive: function() {
					return f
				},
				...
				setHash: function(e) {
					e = A.apply(null, arguments), e !== u && (C(e), e === u && (o.raw || (e = O(e)), t.location.hash = "#" + e))
				},
				replaceHash: function(e) {
					e = A.apply(null, arguments), e !== u && (C(e, !0), e === u && (o.raw || (e = O(e)), t.location.replace("#" + e)))
				},
				getHash: function() {
					return E(u)
				},
				...
				dispose: function() {
					o.stop(), o.initialized.dispose(), o.stopped.dispose(), o.changed.dispose(), l = o = t.hasher = null
				},
				toString: function() {
					return '[hasher version="' + o.VERSION + '" hash="' + o.getHash() + '"]'
				}
			}, o.initialized.memorize = !0, o
		}(window);
		return t
	};
	...
	return r.initHash = function(e) {
		...
		if (e) {
			var i = /^#?(?:([^~]*)~)?(.*)$/.exec(e);
			r.category = i[1], r.queryString = i[2]
		}
		return r
		...
		n.assign(i, e);
		var s = "";
		i.category && (s += i.category + "~"), i.queryString && (s += i.queryString), t.setHash(s)
	}, r
}),
function e(t, n, r) {
	function i(o, u) {
	...
	1: [
		function(e, t, n) {
			var r = e("../main");
			typeof define == "function" && define.amd ? define("perfectScrollbar", r) : (window.PerfectScrollbar = r, typeof window.Ps == "undefined" && (window.Ps = r))
		}, {
			"../main": 7
		}
	],
	...
	3: [
		function(e, t, n) {
			...
			function s(e, t, n) {
				return typeof n == "number" && (n = n.toString() + "px"), e.style[t] = n, e
			}

			function o(e, t) {
				for (var n in t) {
					var r = t[n];
					typeof r == "number" && (r = r.toString() + "px"), e.style[n] = r
				}
				return e
			}
			var r = {};
			r.e = function(e, t) {
				...
				if (typeof e.matches != "undefined") return e.matches(t);
				if (typeof e.matchesSelector != "undefined") return e.matchesSelector(t);
				if (typeof e.webkitMatchesSelector != "undefined") return e.webkitMatchesSelector(t);
				if (typeof e.mozMatchesSelector != "undefined") return e.mozMatchesSelector(t);
				if (typeof e.msMatchesSelector != "undefined") return e.msMatchesSelector(t)
			}, r.remove = function(e) {
	...
	4: [
		function(e, t, n) {
			...
			r.prototype.bind = function(e, t) {
				typeof this.events[e] == "undefined" && (this.events[e] = []), this.events[e].push(t), this.element.addEventListener(e, t, !1)
			...
			i.prototype.eventElement = function(e) {
				...
				return typeof t == "undefined" && (t = new r(e), this.eventElements.push(t)), t
	...
	6: [
		function(e, t, n) {
			...
			n.toInt = function(e) {
				...
				r.add(e, "ps-in-scrolling"), typeof t != "undefined" ? r.add(e, "ps-" + t) : (r.add(e, "ps-x"), r.add(e, "ps-y"))
			}, n.stopScrolling = function(e, t) {
				r.remove(e, "ps-in-scrolling"), typeof t != "undefined" ? r.remove(e, "ps-" + t) : (r.remove(e, "ps-x"), r.remove(e, "ps-y"))
			}, n.env = {
	...
	9: [
		function(e, t, n) {
			...
			t.exports = function(e) {
				var t = s.get(e);
				if (!t) return;
				t.event.unbindAll(), r.remove(t.scrollbarX), r.remove(t.scrollbarY), r.remove(t.scrollbarXRail), r.remove(t.scrollbarYRail), i.removePsClasses(e), s.remove(e)
			}
		}, {
			"../lib/dom": 3,
			"../lib/helper": 6,
			...
			function u(e, t) {
				...
				t.settings.stopPropagationOnClick && t.event.bind(t.scrollbarY, "click", i), t.event.bind(t.scrollbarYRail, "click", function(i) {
					var u = r.toInt(t.scrollbarYHeight / 2),
						...
						l = a / f;
					l < 0 ? l = 0 : l > 1 && (l = 1), o(e, "top", (t.contentHeight - t.containerHeight) * l), s(e), i.stopPropagation()
					...
					var u = r.toInt(t.scrollbarXWidth / 2),
						...
						l = a / f;
					l < 0 ? l = 0 : l > 1 && (l = 1), o(e, "left", (t.contentWidth - t.containerWidth) * l - t.negativeScrollAdjustment), s(e), i.stopPropagation()
				})
			}
			var r = e("../../lib/helper"),
				i = e("../instances"),
			...
			function a(e, t) {
				...
				var n = null,
					...
					f = function(t) {
						...
						i.stopScrolling(e, "x"), t.event.unbind(t.ownerDocument, "mousemove", f)
					};
				t.event.bind(t.scrollbarX, "mousedown", function(o) {
					s = o.pageX, n = i.toInt(r.css(t.scrollbarX, "left")) * t.railXRatio, i.startScrolling(e, "x"), t.event.bind(t.ownerDocument, "mousemove", f), t.event.once(t.ownerDocument, "mouseup", l), o.stopPropagation(), o.preventDefault()
				})
			}
			...
			function f(e, t) {
				...
				var n = null,
					...
					f = function(t) {
						...
						i.stopScrolling(e, "y"), t.event.unbind(t.ownerDocument, "mousemove", f)
					};
				t.event.bind(t.scrollbarY, "mousedown", function(o) {
					s = o.pageY, n = i.toInt(r.css(t.scrollbarY, "top")) * t.railYRatio, i.startScrolling(e, "y"), t.event.bind(t.ownerDocument, "mousemove", f), t.event.once(t.ownerDocument, "mouseup", l), o.stopPropagation(), o.preventDefault()
				})
			}
			var r = e("../../lib/dom"),
				i = e("../../lib/helper"),
			...
			function u(e, t) {
				function u(n, r) {
					...
					if (n === 0) {
						...
						if (i === 0 && r > 0 || i >= t.contentHeight - t.containerHeight && r < 0) return !t.settings.wheelPropagation
					}
					var s = e.scrollLeft;
					if (r === 0) {
						if (!t.scrollbarXActive) return !1;
						if (s === 0 && n < 0 || s >= t.contentWidth - t.containerWidth && n > 0) return !t.settings.wheelPropagation
					}
					return !0
				}
				var n = !1;
				...
				t.event.bind(t.ownerDocument, "keydown", function(a) {
					if (a.isDefaultPrevented && a.isDefaultPrevented()) return;
					if (!n) return;
					var f = document.activeElement ? document.activeElement : t.ownerDocument.activeElement;
					if (f) {
						while (f.shadowRoot) f = f.shadowRoot.activeElement;
					...
					o(e, "top", e.scrollTop - c), o(e, "left", e.scrollLeft + l), s(e), i = u(l, c), i && a.preventDefault()
				})
			}
			var r = e("../../lib/helper"),
				i = e("../instances"),
		...
		function(e, t, n) {
			function o(e, t) {
				...
				function o(e) {
					var t = e.deltaX,
						n = -1 * e.deltaY;
					if (typeof t == "undefined" || typeof n == "undefined") t = -1 * e.wheelDeltaX / 6, n = e.wheelDeltaY / 6;
					return e.deltaMode && e.deltaMode === 1 && (t *= 10, n *= 10), t !== t && n !== n && (t = 0, n = e.wheelDelta), [t, n]
				}
				...
				function u(t, n) {
					...
					if (r) {
						...
						if (s > 0 && !(r.scrollLeft === 0 && t < 0) && !(r.scrollLeft === s && t > 0)) return !0
					}
					return !1
				}
				...
				function a(a) {
					var f = o(a),
						...
						c = f[1];
					if (u(l, c)) return;
					n = !1, t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (c ? s(e, "top", e.scrollTop - c * t.settings.wheelSpeed) : s(e, "top", e.scrollTop + l * t.settings.wheelSpeed), n = !0) : t.scrollbarXActive && !t.scrollbarYActive && (l ? s(e, "left", e.scrollLeft + l * t.settings.wheelSpeed) : s(e, "left", e.scrollLeft - c * t.settings.wheelSpeed), n = !0) : (s(e, "top", e.scrollTop - c * t.settings.wheelSpeed), s(e, "left", e.scrollLeft + l * t.settings.wheelSpeed)), i(e), n = n || r(l, c), n && (a.stopPropagation(), a.preventDefault())
				}
				var n = !1;
			...
			function u(e, t) {
				...
				function f() {
					u || (u = setInterval(function() {
						...
						o(e, "top", e.scrollTop + a.top), o(e, "left", e.scrollLeft + a.left), s(e)
					}, 50))
				}
				...
				t.event.bind(t.ownerDocument, "selectionchange", function() {
					...
					if (c) {
						...
						n.x < i.left + 3 ? (a.left = -5, r.startScrolling(e, "x")) : n.x > i.right - 3 ? (a.left = 5, r.startScrolling(e, "x")) : a.left = 0, n.y < i.top + 3 ? (i.top + 3 - n.y < 5 ? a.top = -5 : a.top = -20, r.startScrolling(e, "y")) : n.y > i.bottom - 3 ? (n.y - i.bottom + 3 < 5 ? a.top = 5 : a.top = 20, r.startScrolling(e, "y")) : a.top = 0, a.top === 0 && a.left === 0 ? l() : f()
					}
				})
			}
			var r = e("../../lib/helper"),
			...
			function o(e, t, n, o) {
				function u(n, r) {
					var i = e.scrollTop,
						...
						u = Math.abs(r);
					if (u > o) {
						if (r < 0 && i === t.contentHeight - t.containerHeight || r > 0 && i === 0) return !t.settings.swipePropagation
					} else if (o > u)
						if (n < 0 && s === t.contentWidth - t.containerWidth || n > 0 && s === 0) return !t.settings.swipePropagation;
					return !0
				}

				function a(t, n) {
					s(e, "top", e.scrollTop - n), s(e, "left", e.scrollLeft - t), i(e)
				}
				...
				function b(e) {
					if (y(e)) {
						d = !0;
						var t = g(e);
						f.pageX = t.pageX, f.pageY = t.pageY, l = (new Date).getTime(), h !== null && clearInterval(h), e.stopPropagation()
					}
				}
				...
				function w(e) {
					if (!p && d && y(e)) {
						...
						var s = (new Date).getTime(),
							o = s - l;
						o > 0 && (c.x = r / o, c.y = i / o, l = s), u(r, i) && (e.stopPropagation(), e.preventDefault())
					}
				}

				function E() {
					!p && d && (d = !1, clearInterval(h), h = setInterval(function() {
						if (!r.get(e)) {
							clearInterval(h);
							return
						}
				...
				var f = {}, l = 0,
					...
					p = !1,
					d = !1;
				n && (t.event.bind(window, "touchstart", v), t.event.bind(window, "touchend", m), t.event.bind(e, "touchstart", b), t.event.bind(e, "touchmove", w), t.event.bind(e, "touchend", E)), o && (window.PointerEvent ? (t.event.bind(window, "pointerdown", v), t.event.bind(window, "pointerup", m), t.event.bind(e, "pointerdown", b), t.event.bind(e, "pointermove", w), t.event.bind(e, "pointerup", E)) : window.MSPointerEvent && (t.event.bind(window, "MSPointerDown", v), t.event.bind(window, "MSPointerUp", m), t.event.bind(e, "MSPointerDown", b), t.event.bind(e, "MSPointerMove", w), t.event.bind(e, "MSPointerUp", E)))
			}
			var r = e("../instances"),
				i = e("../update-geometry"),
				s = e("../update-scroll");
	...
	17: [
		function(e, t, n) {
			...
			t.exports = function(e, t) {
				t = typeof t == "object" ? t : {}, r.add(e, "ps-container");
				var n = s.add(e);
	...
	19: [
		function(e, t, n) {
			...
			t.exports = function(e) {
				...
				var n;
				e.contains(t.scrollbarXRail) || (n = i.queryChildren(e, ".ps-scrollbar-x-rail"), n.length > 0 && n.forEach(function(e) {
					i.remove(e)
				}), i.appendTo(t.scrollbarXRail, e)), e.contains(t.scrollbarYRail) || (n = i.queryChildren(e, ".ps-scrollbar-y-rail"), n.length > 0 && n.forEach(function(e) {
					i.remove(e)
				}), i.appendTo(t.scrollbarYRail, e)), !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = a(t, s.toInt(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = s.toInt((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1, !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight ? (t.scrollbarYActive = !0, t.railYHeight = t.containerHeight - t.railYMarginHeight, t.railYRatio = t.containerHeight / t.railYHeight, t.scrollbarYHeight = a(t, s.toInt(t.railYHeight * t.containerHeight / t.contentHeight)), t.scrollbarYTop = s.toInt(e.scrollTop * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1, t.scrollbarXLeft >= t.railXWidth - t.scrollbarXWidth && (t.scrollbarXLeft = t.railXWidth - t.scrollbarXWidth), t.scrollbarYTop >= t.railYHeight - t.scrollbarYHeight && (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight), f(e, t), t.scrollbarXActive ? r.add(e, "ps-active-x") : (r.remove(e, "ps-active-x"), t.scrollbarXWidth = 0, t.scrollbarXLeft = 0, u(e, "left", 0)), t.scrollbarYActive ? r.add(e, "ps-active-y") : (r.remove(e, "ps-active-y"), t.scrollbarYHeight = 0, t.scrollbarYTop = 0, u(e, "top", 0))
			}
		}, {
			"../lib/class": 2,
			"../lib/dom": 3,
	...
	20: [
		function(e, t, n) {
			...
			i.initEvent("ps-scroll-up", !0, !0), s.initEvent("ps-scroll-down", !0, !0), o.initEvent("ps-scroll-left", !0, !0), u.initEvent("ps-scroll-right", !0, !0), a.initEvent("ps-scroll-y", !0, !0), f.initEvent("ps-scroll-x", !0, !0), l.initEvent("ps-x-reach-start", !0, !0), c.initEvent("ps-x-reach-end", !0, !0), h.initEvent("ps-y-reach-start", !0, !0), p.initEvent("ps-y-reach-end", !0, !0), t.exports = function(e, t, n) {
				if (typeof e == "undefined") throw "You must provide an element to the update-scroll function";
				if (typeof t == "undefined") throw "You must provide an axis to the update-scroll function";
				if (typeof n == "undefined") throw "You must provide a value to the update-scroll function";
				if (t === "top" && n <= 0) {
					e.scrollTop = 0, e.dispatchEvent(h);
					return
				}
				if (t === "left" && n <= 0) {
					e.scrollLeft = 0, e.dispatchEvent(l);
					return
				}
				var m = r.get(e);
				if (t === "top" && n >= m.contentHeight - m.containerHeight) {
					e.scrollTop = m.contentHeight - m.containerHeight, e.dispatchEvent(p);
					return
				}
				if (t === "left" && n >= m.contentWidth - m.containerWidth) {
					e.scrollLeft = m.contentWidth - m.containerWidth, e.dispatchEvent(c);
					return
				}
				d || (d = e.scrollTop), v || (v = e.scrollLeft), t === "top" && n < d && e.dispatchEvent(i), t === "top" && n > d && e.dispatchEvent(s), t === "left" && n < v && e.dispatchEvent(o), t === "left" && n > v && e.dispatchEvent(u), t === "top" && (e.scrollTop = d = n, e.dispatchEvent(a)), t === "left" && (e.scrollLeft = v = n, e.dispatchEvent(f))
			}
		}, {
			"./instances": 18
		}
		...
		r = n.extend({
			...
			_init: function() {
				...
				var e = this._viewModel(),
					n = e.value,
					r = e.encodeHTML;
				e.value.subscribe(i, this), e.encodeHTML.subscribe(i, this), i.call(this)
			},
	...
	var t = e("jquery"),
		...
		i = r.extend({
			...
			_init: function() {
				...
				this._$input = t(i.html(s)[0].firstChild), this._$input.on(this._event("mouseenter"), function() {
			...
			_initAlert: function() {
				function u(e) {
					...
					e ? (r.addClass(i), t.type(e) === "string" && (o[0].innerHTML = n.encodeHTML(e), s.show())) : (r.removeClass(i), s.hide())
				}
				...
				s.on(this._event("mouseenter"), a), s.on(this._event("mouseleave"), f), this._disposable(this._viewModel().alert.subscribe(u, this))
			},
			_initPlaceHolder: function() {
				...
				n.obTypeOf(e) === "ob" ? (e.subscribe(t, this), t.call(this, e())) : e != null && t.call(this, e)
			},
			_initViewUpdater: function() {
				...
				this._disposable(e.disabled.subscribe(function(e) {
					t[0].disabled = !! e
				}, this)), this._disposable(e.value.subscribe(n, this)), n(e.value())
			},
			_initModelUpdater: function() {
				function o(t) {
					if (i.isDisabled()) return;
					e.type === "text" && t.which === 13 && (u(), t.preventDefault())
				}
				...
				var e = this._viewModel(),
					...
					i = this,
					s = e.confirmPoint || {};
				s.blur && r.on(this._event("blur"), u), s.pressEnter && r.on(this._event("keypress"), o)
			},
			_dispose: function() {
		...
		o = r.extend({
			...
			_initContent: function() {
				var e = this._viewModel().dataList,
					t = this._getItemCss(),
					n = [];
				for (var r = 0, o; o = e[r]; r++) n.push('<span class="', t, '" data-', s, '="', r, '">', i(o.text), "</span>");
			...
			_initTooltip: function() {
				function o(n) {
					var r = e[t(n).data(s)],
						o = r.tooltip;
					if (o != null) return r.tooltipEncodeHTML !== !1 ? i(o) : o
				}
				var e = this._viewModel().dataList,
					r = {
						x: 0,
			...
			_initChange: function() {
				...
				this._disposable(n.obSubscribe(e.checked, o)), o(e.checked())
			},
			_initMouse: function() {
				function a() {
				...
				var e = this.$el(),
					...
					u = this.uid();
				e.on(this._event("mouseenter"), "." + i, a), e.on(this._event("mouseleave"), "." + i, f), e.on(this._event("click"), "." + i, l)
			}
		});
	return o
	...
	var t = e("jquery"),
		...
		f, l = r.extend({
			...
			_init: function() {
				var e = this._viewModel();
				n.assert(n.obTypeOf(e.selected)), n.assert(n.obTypeOf(e.highlighted) === "obArray"), this._enhanceOb(), this._initContent(), this._initTooltip(), this._initChange(), this._initMouse(), this._initExpand()
			},
			_enhanceOb: function() {
				var e = this._viewModel();
			...
			_initTooltip: function() {
				function u(n) {
					if (o.isFrozen()) return;
					var r = o._findDataItemByPath(e, t(n).attr(s)),
						u = (r || {}).tooltip;
					if (u != null) return r.tooltipEncodeHTML !== !1 ? i(u) : u
				}
			...
			_initMouse: function() {
				...
				function h(e) {
					if (l.isFrozen()) return;
					t(this).removeClass(o), r.hovered(f)
				}
				...
				var e = this.$el(),
					...
					l = this;
				e.on(this._event("mouseenter"), "." + u, "." + i, c), e.on(this._event("mouseleave"), "." + u, "." + i, h), e.on(this._event("click"), "." + u, p), e.on(this._event("click"), "." + a, d)
			},
			...
			_updateSelectedByModel: function(e, r) {
				var i = this._viewModel(),
					...
					u = [],
					a = this;
				n.assert(s !== "obArray" || t.isArray(e)), this._travelItemText(function(t, i) {
					(s === "obArray" ? n.arrayIndexOf(e, i) >= 0 : i === e) ? (t.addClass(o), r.peekValueInfo("preventExpand") || u.push(a._findItemEl(t))) : t.removeClass(o)
				}), this._showItems(t(u), {
			...
			_updateHighlightedByModel: function(e, r) {
				...
				this._travelItemText(function(t, u) {
					n.arrayIndexOf(e, u) >= 0 ? (t.addClass(i), r.peekValueInfo("preventExpand") || s.push(o._findItemEl(t))) : t.removeClass(i)
				}), this._showItems(t(s), {
					noAnimation: r.peekValueInfo("noAnimation"),
					collapseLevel: r.peekValueInfo("collapseLevel"),
					always: r.peekValueInfo("always"),
			...
			_getAncestorItems: function(e) {
				...
				return e.each(function() {
					var e = t(this),
						...
						s = n._getCss("item"),
						o = e.parent();
					while (o && o.length && !o.hasClass(i)) o.hasClass(s) && r.push(o[0]), o = o.parent()
				}), t(r)
			},
			...
			_expandOrCollapse: function(e, n, r) {
				...
				function m() {
					if (u.isDisposed()) return;
					n === "collapse" && u._resetItemText(h), o.resizeEvent({}), r.always && r.always()
				}
				r = r || {};
				var i = this._getCss("collapsed"),
					s = this._getCss("expanded"),
					o = this._viewModel(),
					u = this,
					f, l, c;
				n === "expand" ? (f = i, l = s, c = "slideDown") : (f = s, l = i, c = "slideUp");
				var h = e.filter("." + f),
					p = {
						withAnimation: [],
						withoutAnimation: []
				...
				}), h.removeClass(f).addClass(l), n === "expand" && this._resetItemText(h), n === "expand" ? v(t.proxy(d, this, m)) : d(t.proxy(v, this, m))
			},
			_toggleSingleItem: function(e) {
				function o(t) {
					if (this.isDisposed()) return;
					t && this._resetItemText(e), i.resizeEvent({})
				}
				var n = this._getCss("collapsed"),
					r = this._getCss("expanded"),
					i = this._viewModel(),
					s = this._findElInItem(e, "list");
				e.hasClass(n) ? (e.removeClass(n).addClass(r), s.slideDown(a, t.proxy(o, this, !1)), this._resetItemText(e)) : e.hasClass(r) && (e.removeClass(r).addClass(n), s.slideUp(a, t.proxy(o, this, !0)))
			},
			hasValue: function(e) {
				function n(n) {
					n.value === e && (t = !0)
				...
				if (e && e.length) {
					...
					for (var s = 0, o = e.length; s < o; s++) {
						var u = e[s],
							a = n + s,
							f = s === o - 1;
						t.preChildren && t.preChildren(u, a, r, f, i), this._travelData(u.children, t, a, u, i + 1), t.postChildren && t.postChildren(u, a, r, f, i)
					}
			...
			_findDataItemByPath: function(e, t) {
				t = t.split(","), e = e || [];
				var n;
				for (var r = 0, i = t.length; r < i && e; r++) n = e[t[r]], e = (n || {}).children;
				return n
			},
	...
	function i(e) {
		...
		if (r[t].hasOwnProperty(e)) return r[t][e]
	}
	var t = "cn",
		n = {
			panelBaseZIndex: 9e5,
	...
	var t = e("jquery"),
		...
		s = i.attach(r.extend({
			...
			_construct: function() {
				...
				return u.call(this, this.PanelState.CREATED), e
			},
			dispose: function() {
				var e = this._applySuper("dispose", arguments);
				return u.call(this, this.PanelState.DISPOSED), e
			},
			enter: function(e) {
				if (!this.isOpened()) return !1;
				this.getPanelState() === this.PanelState.CREATED && (this._fillContent(e), u.call(this, this.PanelState.READY)), this._enter(e), u.call(this, this.PanelState.DATA_FILLED)
			},
			_fillContent: t.noop,
			_enter: t.noop,
			clear: function() {
				if (!a.call(this, [this.PanelState.DATA_FILLED, this.PanelState.READY])) return;
				this._clear(), u.call(this, this.PanelState.READY)
			},
			_clear: t.noop,
			isOpened: function() {
				...
				if (u.readyState === 4) {
					if (u.status >= 200 && u.status < 300) {
						var e = u.responseText,
							t = n.config();
						(typeof t.autoCompile == "undefined" || t.autoCompile) && r.compile(e), i(e)
					}
					u.onreadystatechange = new Function, u = null
				}
			}, u.send(null)
		}
	}
	...
	var t = e("jquery"),
		...
		l, c = s.attach(i.extend({
			...
			_init: function() {
				...
				l == null && (l = r("panelBaseZIndex")), this._manuInitView(e);
				var n = s(this);
				n.mainEl = e, n.isOpen = !1, this.$el("winPanel$content", e.find(a)), n.maskKey = Math.random() + "", e.on(this._event("click"), u, t.proxy(i, this)), this._afterInit(this.$content())
			},
			_disposeFinally: function() {
				var e = s(this);
				n.disposeGlobalMask(e.maskKey), e.mainEl.remove(), e.mainEl = null
			},
			open: function(e) {
				function a() {
				...
				}), u.isOpen = !0, this._beforeShow(o, e), i.show(), this._afterShow(o, e), i.css({
			...
			close: function() {
				...
				e.animate({
					...
					e.hide(), n.globalMask(!1, t.maskKey), i._afterHide(i.$content()), i.fire("close")
				})
			},
			$content: function() {
		...
		o = n.extend({
			...
			_init: function() {
				function h() {
					...
					n.addClass(o), a && n.addClass(u)
				}

				function p() {
					n.removeClass(o), n.removeClass(u)
				}

				function d() {
					if (e.disabled()) return;
					n.addClass(u), a = !0, f.one(i._event("mouseup"), function() {
						a = !1
					})
				}
				...
				var e = this._viewModel(),
					...
					a = !1,
					f = t(document);
				this._eventHandlerMap = {}, n.on(this._event("mouseenter"), h), n.on(this._event("mouseleave"), p), n.on(this._event("mousedown"), d), n.on(this._event("mouseup"), v);
				var l = this;
			...
			_parseViewModel: function(e, t) {
				return t.text != null && (e.text = t.text), t.css != null && (e.css = t.css), t.dontEncodeHTML != null && (e.dontEncodeHTML = t.dontEncodeHTML), e
			},
			on: function(e, n) {
				r.assert(e.indexOf(".") < 0);
				var i = this._eventHandlerMap;
				t.inArray(e, s) >= 0 && (i[e] = i[e] || [], i[e].push(n))
			},
	...
	function l(e, r) {
		...
		for (var f = 0, l = r.length; f < l; f++) {
			...
			if (h && c) {
				var d = c[h];
				d.itemType && (a = this.getCptClass(d.itemType)), d.itemTplTarget && (s = d.itemTplTarget), d.itemTplParam && (o = d.itemTplParam)
			}
			var v = t(s ? this._renderTpl(s, t.extend({
				index: e + f,
				itemTplParam: o
			}, c)) : "<div></div>");
			n.assert(v.length === 1, "MUST be only one root element in item tpl!"), p.call(this, v, e + f);
			var m = new a(v, c);
			i.splice(e + f, 0, m)
		}
	}
	...
	function h(e, t) {
		var n = this._items(),
			...
			i = r.$el(),
			s = n[t].$el();
		t > e ? i.insertAfter(s) : i.insertBefore(s), n.splice(e, 1)[0], n.splice(t, 0, r)
	}
	...
	var t = e("jquery"),
		...
		u = s.attach(r.extend({
			...
			_prepare: function() {
				...
				this._sub(o, []), this._setItemsContainer(), this._disposable(e.subscribe(a, this, "arrayChange"));
				var t = {
					key: i.SPLICE,
					index: 0,
					removeCount: 0,
				...
				for (var n = 0, r = e.peek(), s = r.length; n < s; n++) t.added.push(r[n]);
				a.call(this, t)
			},
			_dispose: function() {
	...
	return f[i.REMOVE] = function(e) {
		var t = e.indexes;
		for (var n = 0, r = t.length; n < r; n++) c.call(this, t[n], 1)
	}, f[i.SPLICE] = function(e) {
		e.removeCount && c.call(this, e.index, e.removeCount), e.added.length && l.call(this, e.index, e.added)
	}, f[i.MOVE] = function(e) {
	...
	var t = e("./ui/Component"),
		n = t.cptClasses;
	n.Text = e("./ui/Text"), n.TextInput = e("./ui/TextInput"), n.CheckButton = e("./ui/CheckButton"), n.TreeList = e("./ui/TreeList"), n.WinPanel = e("./ui/WinPanel"), n.Button = e("./ui/Button"), n.Foreach = e("./ui/Foreach")
}), define("docTool/main", ["require", "jquery", "dt/ui/Component", "./schemaHelper", "dt/lib", "dt/tpl", "./docUtil", "./lang", "./hashHelper", "perfectScrollbar", "prettyPrint", "ecLog", "dt/componentConfig", "tpl!./main.tpl.html"], function(e) {
	function M(e) {
	...
	var p = "APIMain",
		d = ".ecdoc-api-hover-desc",
		v = ".query-collapse-radio input[type=radio]",
		m = ".query-result-info",
		g = ".ecdoc-api-doc-group-content",
		y = ".ecdoc-api-tree-area",
		b = ".ecdoc-api-doc-group-area",
		w = "ecdoc-api-doc-line-expand",
		E = "ecdoc-api-doc-group-line-highlight",
		S = "ecdoc-api-doc-sub-group",
		x = c.down,
		T = c.left,
		N = "ecdoc-api-doc-group-line",
		C = /<iframe[^>]*>.*?<\/iframe>/g,
		k = !0,
		L = {}, A;
	L.init = function() {
	...
	var O = n.extend({
		...
		_initHash: function() {
			function t(t) {
				k && _({
					key: "initHash",
					data: t
				}), t || (t = o.getGlobalArg("initHash", "")), t && e._handleHashQuery(t), k = !1
			}
			var e = this;
			a.initHash(t)
		},
		_initScroll: function() {
			var e = this.$el(),
				t = {}, n = e.find(b);
			f.initialize(e.find(y)[0], t), f.initialize(n[0], t);
			var r = this;
		...
		_prepare: function() {
			function e(e, t) {
				this._prepareDoc(e), this._applyTpl(this.$el(), p), this._initDoc(), this._initHash(), this._initScroll()
			}
		...
		_initDoc: function() {
			this._initTree(), this._initQueryBox(), this._initDescArea()
		},
		_initTree: function() {
			function n(e, t, n) {
			...
			function r(e, t, n) {
				var r = n.getTreeDataItem(!0),
					s = this.$el();
				e && r && (this._updateDescArea(r), k || _({
					key: "clickTreeItem",
					data: r.optionPathForHash
				}), i.call(this, r), s.find("." + E).removeClass(E), this._findDescNode(r.value).addClass(E), r.optionPathForHash && a.hashRoute({
			...
			var e = this._viewModel();
			this._disposable(e.apiTreeHovered.subscribe(t.proxy(n, this, !1))), this._disposable(e.apiTreeSelected.subscribe(t.proxy(r, this, !0))), this._disposable(e.apiTreeResize.subscribe(t.proxy(s, this, !0)))
		},
		_initQueryBox: function() {
			function s(t) {
				...
				e.viewModel("placeholder")(r.placeholder), o.call(this, !0)
			}
			...
			function u() {
				_({
					key: "collapseAll"
				}), this._setResultInfo(null), this._viewModel().apiTreeHighlighted([], {
					collapseLevel: 1
				})
			}
			...
			i.subscribe(s, this), s.call(this, i()), this._sub("collapseAll").on("click", t.proxy(u, this)), t(document).keypress(function(t) {
				var n = (t.target.tagName || "").toLowerCase();
				t.which === 47 && n !== "input" && n !== "textarea" && (e.focus(), e.select(), t.preventDefault())
			})
		},
		_initDescArea: function() {
			function n(t) {
				...
				r.subGroup[0].style.display === "none" ? (_({
					key: "expandDesc",
					data: s
				}), r.expandBtn[0].innerHTML = x, r.subGroup.slideDown().promise().always(e)) : (_({
					key: "collapseDesc",
					data: s
				}), r.expandBtn[0].innerHTML = T, r.subGroup.slideUp().promise().always(e))
			}
		...
		_updateDescArea: function(e) {
			...
			var n = this.$el(),
				...
				o = s[0],
				u = "";
			o !== this._lastDescBase && (u = this._createDescHTML(o, e), r[0].innerHTML = u), this._lastDescBase = o, this._doExpand(s, r, e), r.find("pre code").each(function(e, n) {
				t(n).addClass("prettyprint")
			}), l(), f.update(n.find(b)[0]);
			var a = i.find("iframe");
			c(), this._doLazyLoad = c
		},
		_findDescNode: function(e) {
			var n = t.isArray(e),
				r = {};
			if (n)
				for (var i = 0; i < e.length; i++) r[e[i]] = 1;
		...
		_getTraceToComponentRoot: function(e) {
			var t = [],
				n, r = e;
			while (r && (n = r.parent) && n.parent && (!r.isEnumParent || r === e)) t.push(r), r = n;
			return t.reverse()
		},
			...
			function o(e, t) {
				...
				for (var u = 0; u < r.length; u++) {
					var a = n._wrapDesc(r[u]),
						f = "";
					r[u].hasObjectProperties && (f = o(r[u], t)), i.push(s.render("descGroupLine", {
		...
		_doExpand: function(e, n, r) {
			var i = [];
			for (var s = 1; s < e.length; s++) i.push(e[s].value);
			var o = this._findDescNode(i),
				u = this;
			o.each(function(e, n) {
				var r = u._findElInDescNode(t(n));
				if (!r.subGroup.length) return;
				r.expandBtn[0].innerHTML = x, r.subGroup.show()
			})
		},
		...
		_handleHashQuery: function(e) {
			...
			if (!t || e !== t.optionPathForHash) k || _({
		...
		doQuery: function(e, n, i, s) {
			...
			try {
				var u = {};
				u[n] = e, o = r.queryDocTree(this._docTree, u)
			} catch (a) {
				alert(a);
				return
			}
			...
			if (!o.length) return;
			var l = [];
			for (var c = 0, h = o.length; c < h; c++) l.push(o[c].value);
