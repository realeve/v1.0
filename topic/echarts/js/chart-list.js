...
$(document).ready(function() {
	var t = $("#explore-container .chart-list-panel"),
		e = $("#left-chart-nav ul");
	for (var i in CHART_TYPES) t.append('<h3 class="chart-type-head" id="chart-type-' + i + '">' + CHART_TYPES[i] + "</h3>").append('<div class="row" id="chart-row-' + i + '"></div>'), e.append($("<li>").append('<a class="left-chart-nav-link" id="left-chart-nav-' + i + '" href="#chart-type-' + i + '"><div class="chart-icon"></div><div class="chart-name">' + CHART_TYPES[i] + "</div></a>"));
	for (var a = 0, l = EXAMPLES.length; l > a; ++a) {
